...
function CommandList({
  ...
  return (
    <CommandPrimitive.List
      ...
      className={cn(
        `
          scrollbar-track-transparent scrollbar-thumb-accent scrollbar
...
function CommandGroup({
  ...
  return (
    <CommandPrimitive.Group
      ...
      className={cn(
        `
          text-foreground mb-2 overflow-hidden p-1 tracking-wide
          [&_[cmdk-group-heading]]:text-muted-foreground
...
function CommandShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        `
          text-muted-foreground bg-muted/50 ml-auto rounded-md px-1 py-0.5
