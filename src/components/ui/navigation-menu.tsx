...
const navigationMenuTriggerStyle = cva(`
  group bg-background ring-ring/10 outline-ring/50 inline-flex h-9 w-max
  ...
  return (
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          `
            origin-top-center bg-popover text-popover-foreground relative mt-1.5
    ...
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        `
          ...
          hover:bg-accent hover:text-accent-foreground
          focus:bg-accent focus:text-accent-foreground
          ring-ring/10 outline-ring/50 flex flex-col gap-1 rounded-sm p-2
